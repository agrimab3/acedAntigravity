...
> = {
  ...
  math: {
    ...
    points: [
      { x: 0.72, y: 0.08, topicSlug: "number-and-quantity" },
      { x: 0.57, y: 0.22, topicSlug: "algebra" },
      { x: 0.43, y: 0.30, topicSlug: "linear-equations" },
      { x: 0.59, y: 0.34, topicSlug: "functions" },
      { x: 0.74, y: 0.39, topicSlug: "quadratics-and-polynomials" },
      { x: 0.90, y: 0.36, topicSlug: "geometry" },
      { x: 0.30, y: 0.46, topicSlug: "ratios-and-proportions" },
      { x: 0.16, y: 0.60, topicSlug: "statistics-and-probability" },
      { x: 0.37, y: 0.83, topicSlug: "data-analysis" },
      { x: 0.58, y: 0.88, topicSlug: "integrating-essential-skills" },
      { x: 0.80, y: 0.79, topicSlug: "modeling" },
      { x: 0.93, y: 0.62, topicSlug: "coordinate-geometry" },
      { x: 0.22, y: 0.82, topicSlug: "applied-word-problems" },
    ],
    lines: [
      [0, 1],
      [1, 2],
