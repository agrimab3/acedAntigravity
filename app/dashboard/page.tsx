...
> = {
  ...
  math: {
    ...
    points: [
      ...
      { x: 0.55, y: 0.31, topicSlug: "algebra" },
      { x: 0.28, y: 0.47, topicSlug: "functions" },
      { x: 0.42, y: 0.69, topicSlug: "geometry" },
      { x: 0.66, y: 0.70, topicSlug: "statistics-and-probability" },
      { x: 0.80, y: 0.92, topicSlug: "integrating-essential-skills" },
      { x: 0.72, y: 0.45, topicSlug: "modeling" },
      { x: 0.38, y: 0.51, topicSlug: "linear-equations" },
      { x: 0.14, y: 0.64, topicSlug: "ratios-and-proportions" },
      { x: 0.26, y: 0.94, topicSlug: "data-analysis" },
      { x: 0.48, y: 0.82, topicSlug: "applied-word-problems" },
      { x: 0.67, y: 0.82, topicSlug: "quadratics-and-polynomials" },
      { x: 0.86, y: 0.46, topicSlug: "coordinate-geometry" },
    ],
    lines: [
      [0, 1],
      [1, 2],
